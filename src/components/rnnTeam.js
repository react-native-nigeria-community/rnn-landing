...
const Team = () => {
  return (
   ...
   <section  className=' ml-10 mr-10 mt-16 md:mt-20 lg:mt-24 px-4 sm:px-8 md:px-12 flex items-center justify-center grid-cols-2 gap-10 '  s>
        <div className=''>
         
          <h1 className="text-white text-5xl font-base leading-[1.4] tracking-wider items-baseline">
          Meet the Team Behind React <br /> Native Nigeria
          </h1>
          <p className='text-white mt-5 mb-6 text-2xl font-[300]'>
            Our team is a dedicated group of React Native enthusiasts, <br/>
             ...
             <button className='items-center  px-30 py-3   bg-blue-500  rounded-md text-white  text-500 bg-[#00B4D8] hover:bg-white hover:text-black transition duration-300 ease-in' >
<a   href="https://photos.google.com/share/AF1QipPc49tLOW3EZO1RMO8awcVCBIBz92OMZIiHhSCtQKhlLP5-ro4m3vYbsdezylP0yg?key=cE5LeVNNelh0dEJNNHIxRU1mWDhWMG1wd0FsUkJn" 
     >         View All Team    </a>
        ...
        <div>
          <img src={team1} className='ml-20 w-full max-h-screen '  alt="" />
        </div>
      </section>
        </div>
<div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 px-4 lg:gap-8">
  ...
  <div className=" mr-22 w-full sm:w-1/3">
    <img
      src={team4}
      alt="Team Member 3"
      className="w-full h-[400px] object-cover rounded-lg  "
